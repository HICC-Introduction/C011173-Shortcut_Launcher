...
##윈도우창에 위젯 설정하기
##main program
b1=tkinter.Button(window, text="메모장", command= Notepad)
b2=tkinter.Button(window, text="계산기", command= Calc)
b3=tkinter.Button(window, text="폴더 C:\\", command= Folder_C)
b4=tkinter.Button(window, text="구글", command= Google)
